function mul = MUL_Fixed_LUT_ALM_2(e, A, B, n_h, n_l, v_h, v_l, app_k)
    ...
    lut_h = load(['LUT_ALM_luth_e' num2str(e) '_vh' num2str(v_h) '_vl' num2str(v_l) '_model2.mat']);
    lut_h = lut_h.init_lut_h_final;
    lut_l = load(['LUT_ALM_lutl_e' num2str(e) '_vh' num2str(v_h) '_vl' num2str(v_l) '_model2.mat']);
